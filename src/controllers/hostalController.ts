...
class HostalController {
  ...
  async listAllHostales(req: Request, res: Response) {
  ...
  async createHostal(req: Request, res: Response) {
    const dataUser = {
      rut: req.body.rut,
  ...
  async deleteHostal(req: Request, res: Response) {
...
export const hostalController = new HostalController();